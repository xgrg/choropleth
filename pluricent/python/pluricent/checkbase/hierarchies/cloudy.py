...
patterns = { 'raw': os.path.join('(?P<database>[\w -/]+)', '(?P<subject>\w+)', 'anatomy', '(?P=subject)_3DT1_(?P<number>\d{3}).nii.gz$'),
             'left_greywhite': os.path.join('(?P<database>[\w -/]+)', '(?P<subject>\w+)', 'analysis', '(?P=subject)_left_greywhite.nii.gz$'),
             'right_greywhite': os.path.join('(?P<database>[\w -/]+)','(?P<subject>\w+)', 'analysis', '(?P=subject)_right_greywhite.nii.gz$'),
             'nobias': os.path.join('(?P<database>[\w -/]+)', '(?P<subject>\w+)', 'analysis', '(?P=subject)_nobias.nii.gz$'),
             'split': os.path.join('(?P<database>[\w -/]+)', '(?P<subject>\w+)', 'analysis', '(?P=subject)_split.nii.gz$'),
             'brainmask': os.path.join('(?P<database>[\w -/]+)', '(?P<subject>\w+)', 'analysis', 'split_(?P=subject).nii.gz$'),
             'left_white': os.path.join('(?P<database>[\w -/]+)', '(?P<subject>\w+)', 'analysis', '(?P=subject)_(?P<side>[L]?)white.(?P<extension>%s)'%mesh_extensions),
             'right_white': os.path.join('(?P<database>[\w -/]+)', '(?P<subject>\w+)', 'analysis', '(?P=subject)_(?P<side>[R]?)white.(?P<extension>%s)'%mesh_extensions),
